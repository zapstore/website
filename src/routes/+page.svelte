    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start">
      ...
      <div class="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
        ...
        >
          ...
          <a href="/developers" class="btn-secondary group">
            For Developers
            <ArrowRight
...
<!-- Pillars Section -->
<section
  class="py-16 lg:py-24 border-t border-border/50 relative overflow-hidden"
>
    ...
    >
      ...
      <div class="group">
        ...
        >
          ...
          <div
            class="absolute inset-0 opacity-[0.03] bg-[linear-gradient(to_right,hsl(var(--foreground))_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--foreground))_1px,transparent_1px)] bg-[size:24px_24px]"
          ></div>
          <!-- Corner accent -->
          <div class="absolute top-0 left-0 w-16 h-16 overflow-hidden">
            <div
              class="absolute top-2 left-2 w-8 h-[2px] bg-gradient-to-r from-primary/60 to-transparent"
            ></div>
            <div
              class="absolute top-2 left-2 w-[2px] h-8 bg-gradient-to-b from-primary/60 to-transparent"
            ></div>
          </div>
          ...
          <div class="relative">
            ...
            <h3
              class="text-xl font-semibold text-foreground mb-3 tracking-tight"
            >
              Social discovery
            </h3>
      ...
      <div class="group">
        ...
        >
          ...
          <div class="absolute top-0 left-0 w-16 h-16 overflow-hidden">
            <div
              class="absolute top-2 left-2 w-8 h-[2px] bg-gradient-to-r from-emerald-500/60 to-transparent"
            ></div>
            <div
              class="absolute top-2 left-2 w-[2px] h-8 bg-gradient-to-b from-emerald-500/60 to-transparent"
            ></div>
          </div>
      ...
      <div class="group">
        ...
        >
          ...
          <div class="absolute top-0 left-0 w-16 h-16 overflow-hidden">
            <div
              class="absolute top-2 left-2 w-8 h-[2px] bg-gradient-to-r from-amber-500/60 to-transparent"
            ></div>
            <div
              class="absolute top-2 left-2 w-[2px] h-8 bg-gradient-to-b from-amber-500/60 to-transparent"
            ></div>
          </div>
      ...
      <div class="group">
        ...
        >
          ...
          <div class="absolute top-0 left-0 w-16 h-16 overflow-hidden">
            <div
              class="absolute top-2 left-2 w-8 h-[2px] bg-gradient-to-r from-sky-500/60 to-transparent"
            ></div>
            <div
              class="absolute top-2 left-2 w-[2px] h-8 bg-gradient-to-b from-sky-500/60 to-transparent"
            ></div>
          </div>
    ...
    <div class="relative max-w-3xl mx-auto">
      ...
      <div class="relative px-6 py-12 lg:px-12 lg:py-14 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a href="/apps" class="btn-secondary group">
            Browse apps
            <ChevronRight
