...
description: End-to-end workflow for publishing apps and CLI tools to Zapstore.
weight: 1
---

# Zapstore App Developer Guide

This guide targets Android and CLI developers who want to distribute software through Zapstore. It links the two key components of the ecosystem:

- **Zapstore mobile app** (`zapstore/`): the user-facing Flutter storefront on Android.
